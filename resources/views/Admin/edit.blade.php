...
<section class="content">
        ...
        <div class="col-md-8">
            <div class="card card-primary">
                <div class="card-header">
                    <h3 class="card-title">    @if (Auth::user()->is_admin==1)
   ...
   @endif</h3>
                ...
                <div class="card-body">
                    <form class="form-group" method="POST" action="/admin/{{ $user->id }}">
                        @csrf
                        @method('PUT')
                        ...
                        <input type="text" id="phone" name="phone" value="0{{ $user->phone }}"  class="form-control">
                        ...
                        <input type="password" id="password-conf" name="password_confirmation" value=""  class="form-control">
                        
                        <label for="is_admin">Is_admin</label>
                        <input type="text" id="is_admin" name="is_admin" value=""  class="form-control">
                      
         
                        <button type="submit" value="Add_User" name="submit" class="btn btn-success float-right">edit</button>
                     </form>
                     @if ($errors->any())
