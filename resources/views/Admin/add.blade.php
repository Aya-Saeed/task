            ...
            <div class="card card-primary">
                ...
                <div class="card-body">
                    <form class="form-group" method="POST" action="/admin">
                        ...
                        <input type="text" id="username" name="name" value=""  class="form-control">
                        ...
                        <button type="submit" value="Add_User" name="submit" class="btn btn-success float-right">add</button>
                     </form>
                     @if ($errors->any())
